...
function AuthorsTab({ currentIndex, tabIndex, albumId, wykonawcy, authorDelete }) {
                        ...
                        wykonawcy.map((wykonawca, idx) => (
                            <Grid item key={`TabPanel1_${wykonawca.nazwa}${idx}`}>
                                <Grid container alignItems="center" columnSpacing={2}>
                                    ...
                                    <Grid item onClick={() => authorDelete(albumId, idx)}>
...
AuthorsTab.propTypes = {
    ...
    wykonawcy: PropTypes.array.isRequired,
    authorDelete: PropTypes.func.isRequired,
};
